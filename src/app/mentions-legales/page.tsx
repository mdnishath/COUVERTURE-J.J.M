...
export const metadata: Metadata = {
  ...
  description: "Mentions légales du site COUVERTURE J.J.M.",
};
          ...
          <AnimatedSection>
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                ...
                destinées exclusivement à COUVERTURE J.J.M pour le traitement
              ...
              <p className="text-gray-600 leading-relaxed">
                COUVERTURE J.J.M s&apos;efforce d&apos;assurer au mieux
                l&apos;exactitude et la mise à jour des informations diffusées
                sur ce site. Toutefois, COUVERTURE J.J.M ne peut garantir
