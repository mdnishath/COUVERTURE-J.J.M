...
const timeline = [
  {
    ...
    text: "Fondation de COUVERTURE J.J.M à Fréjus avec une vision claire : offrir un service de couverture d'exception.",
  },
  {
    year: "2013",
    title: "Expansion dans le Var",
    text: "Extension de notre zone d'intervention à l'ensemble du département du Var.",
  },
  {
    year: "2018",
