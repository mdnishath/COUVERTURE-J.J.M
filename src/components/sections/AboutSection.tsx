...
export default function AboutSection({ content, sectionStyle }: AboutSectionProps) {
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl">
                <div className="aspect-[4/3] relative">
                  <Image
                    src={aboutImage}
                    alt="\u00c9quipe COUVERTURE J.J.M au travail"
                    fill
              ...
              <div className="absolute -bottom-6 -right-6 bg-primary text-white rounded-2xl p-6 shadow-xl">
                <div className="text-center">
                  ...
                  <span className="text-sm font-medium opacity-90">
                    {(() => {
                      const badgeText = (content?.badge_text as string) ?? "Ann\u00e9es\nd'Exp\u00e9rience";
          ...
          <AnimatedSection direction="right">
            <span
              ...
              style={{
                ...
                ...(sectionStyle?.subtitleWeight ? { fontWeight: parseInt(sectionStyle.subtitleWeight) } : {}),
              }}
            >
            ...
            >
              {(() => {
                const title = (content?.title as string) ?? "L'Excellence au Service de Votre Toiture";
                const words = title.split(" ");
                const accent = words.slice(-2).join(" ");
                const prefix = words.slice(0, -2).join(" ");
                return <>{prefix}{" "}<span className="text-primary">{accent}</span></>;
              })()}
            </h2>
            <p
            ...
            >
              {(content?.description as string) ?? "Depuis plus de 15 ans, COUVERTURE J.J.M accompagne les particuliers et professionnels du Var dans tous leurs projets de couverture et charpente. Notre engagement : un travail soign\u00e9, des mat\u00e9riaux de qualit\u00e9 et le respect de vos exigences."}
            </p>
            ...
            >
              {(content?.button_text as string) ?? "D\u00e9couvrir Notre Entreprise"}
            </Button>
          </AnimatedSection>
        </div>
            ...
            <AnimatedSection key={value.title} delay={index * 0.15}>
              <div
                className={`text-center p-8 ${
                  ...
                  sectionStyle?.cardShadow ? cardShadowClass : "hover:shadow-card"
