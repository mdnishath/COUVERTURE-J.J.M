...
export default function ContactFormSection({ content, siteConfig, formConfig, sectionStyle }: ContactFormSectionProps) {
  const title = (content?.title as string) || "Envoyez-nous un Message";
  const description = (content?.description as string) || "Remplissez le formulaire et nous vous répondrons rapidement.";
            ...
            <div className="space-y-6">
              ...
              <div className="bg-primary text-white rounded-2xl p-8">
                ...
                <p className="text-white/80 text-sm mb-6">
                  ...
                  intervenons sous 24h dans tout le Var.
                </p>
                <a
