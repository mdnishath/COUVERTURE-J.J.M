...
export default function BeforeAfterGallery({ projects, content, sectionStyle }: BeforeAfterGalleryProps) {
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4">
        <SectionTitle
          ...
          title={(content?.title as string) || "Avant / Après : La Preuve par l'Image"}
          description={(content?.description as string) || "D\u00e9couvrez la qualit\u00e9 de notre travail \u00e0 travers nos r\u00e9alisations r\u00e9centes."}
                ...
                <AnimatedSection delay={index * 0.1}>
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden">
                      {/* Before image */}
                      <Image
                        src={project.beforeImage || "/images/placeholder-before.jpg"}
                      ...
                      <Image
                        src={project.afterImage || "/images/placeholder-after.jpg"}
