...
export default function CTABanner({ siteConfig, content, sectionStyle }: CTABannerProps) {
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 lg:py-24 text-center">
        ...
        >
          <h2
            ...
            style={{
              fontSize: "var(--s-title-size, clamp(1.625rem, 2vw + 0.8rem, 2.5rem))",
          ...
          >
            {(content?.heading as string) ?? "Besoin d'un Couvreur Professionnel ?"}
          </h2>
          <p
          ...
          >
            {(() => {
              const desc = (content?.description as string) ?? "Demandez votre devis gratuit dès maintenant.\nRéponse garantie sous 24 heures, sans engagement.";
