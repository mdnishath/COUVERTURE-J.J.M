    ...
    <div>
      <div className="max-w-7xl mx-auto px-4">
        <SectionTitle
          ...
          title={(content?.title as string) || "Nous Intervenons dans Tout le Var"}
          description={(content?.description as string) || "Basés à Fréjus, nous couvrons l'ensemble du département du Var et ses environs."}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection direction="left">
            <div className="rounded-2xl overflow-hidden shadow-card h-[400px] bg-gray-100">
              <iframe
                ...
                title="Localisation COUVERTURE J.J.M"
              />
            </div>
          </AnimatedSection>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-5">
                <p className="text-sm text-gray-600">
                  {(content?.footer_text as string) || "Votre ville n'est pas listée ? Contactez-nous ! Nous intervenons dans un rayon de 50 km autour de Fréjus."}
                </p>
              </div>
            </div>
          </AnimatedSection>
